	...
	class Moshare {
		...
		public static function options_form() {
			...
			echo '
				...
				<h3>Do you want the services button on your excerpts?</h3>
				<input type="radio" name="moshare_excerpt" value="yes" '. $yes .' /> Yes
				<input type="radio" name="moshare_excerpt" value="no" '. $no .' /> No
				<h3>Advanced</h3>
		...
		public static function scripts() {
			$services = explode(',', get_option('moshare_services'));
			wp_enqueue_script('moshare', 'http://sl10/moshare/embed/moshare.js', array(), '1.1', true);
			foreach ($services as $service) {
				if ($service == 'linkedin') {
